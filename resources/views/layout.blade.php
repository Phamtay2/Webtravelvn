                       ...
                       <div class="cl-right-lang fr">
                           <div class="bx-lang-rh">
                               <ul class="swift-lang-r">
                                   <div class="auth-buttons" style="float: right; margin-top: 10px;">
        @auth
                   ...
                   <div class="col-md-12 col-xs-12 box-mainmenu">
                       <nav class="menunav">
                           <ul class="ulwap-mainmenu">
                               <li><a href="{{ route('hom') }}" class="mn-home"><i class="fa fa-home"></i></a>
                               </li>
       ...
       <div class="slider-wrapper theme-default">
           <div id="slider-master" class="nivoSlider">
               ...
               <a href="#"><img src="{{ asset('frontend/images/du_lich_he_2022-min.png') }}"
                       data-thumb="{{ asset('frontend/images/du_lich_he_2022-min.png') }}"
                       alt="aa" title="" /></a>
           ...
           <div class="col-md-4 col-xs-12 bx-child-ph bx-child-ph2">
               ...
               <div class="w100 fl item-lst-pos2">
                   <a href="https://vietnamtravel.net.vn/vi/ct/82-hon-18-nam-kinh-nghiem.html"><img
                           src="{{asset('/frontend/images/18_kinhnghiem_vn.jpg')}}" alt="Hơn 18 năm kinh nghiệm"></a>
