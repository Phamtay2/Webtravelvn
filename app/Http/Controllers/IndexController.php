    ...
    public function showTours()
{
    ...
    // Nhóm các tour theo danh mục cha
    $tours = Tour::with('category')->get()->groupBy(function($tour) {
        return $tour->category->category_parent;
    });

    return view('tours.index', compact('category_parent', 'tours'));
}
